...
AdBlock.prototype.loadFilterLists = function () {
  'use strict';
  var self = this;
  self.parseFilterList('plugins/easylist.txt');
};

AdBlock.prototype._onResourceRequested = function (requestData, networkRequest) {
  var self = this;
  return !self.getIsAd(requestData.url);
};
